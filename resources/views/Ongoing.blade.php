...
<body>
    ...
    <div class="w3-teal">
        ...
        <div class="d-inline ">
            <h3 class="d-inline "><b>Ongoing</b></h3>
        </div>
    </div>
    <div>
        ...
        <div class="card bg-cream rounded-20 mt-4 container bg-info">
            <div class="card-body">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="align-middle">
                                <a href="" class="btn btn-1 btn-success text-white rounded-10">CheckOut</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
