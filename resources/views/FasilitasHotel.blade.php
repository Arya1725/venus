...
<body>
    ...
    <div class="w3-sidebar w3-bar-block w3-border-right" style="background: #00FFFF; display:none;" id="mySidebar">
        ...
        <a href="#" class="w3-bar-item w3-button">Resepsionis</a><br>
    </div>
    ...
    <div class="w3-teal">
        ...
        <div class="d-inline ">
            <h3 class="d-inline "><b>Fasilitas Hotel</b></h3>
        </div>
    </div>
    <center>
                ...
                <table class="table border border-dark">
                    ...
                    <tbody>
                        <tr>
                            <th scope="row">1</th>
                            <td>Kolam Renang</td>
                            <td>Nikmati kolam renang yang luas dan nyaman.</td>
                            <td><img src="assets/image/12.jpg" class="card-img-top" style="max-width: 150px"
                                    alt="...">
                            </td>
